...
const GROUP_STYLES: Record<string, GroupStyle> = {
  obligation: {
    color: "#73A5CA",
    headerBg: "bg-[#73A5CA]/8 dark:bg-[#73A5CA]/20",
    headerText: "text-[#73A5CA] dark:text-blue-300",
    accentText: "text-[#73A5CA] dark:text-blue-300",
    badge: "bg-[#73A5CA]/10 dark:bg-[#73A5CA]/30 text-[#73A5CA] dark:text-blue-300",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
  necessity: {
    color: "#FFC81E",
    headerBg: "bg-[#FFC81E]/8 dark:bg-[#FFC81E]/20",
    headerText: "text-[#FFC81E] dark:text-emerald-300",
    accentText: "text-[#FFC81E] dark:text-emerald-300",
    badge: "bg-[#FFC81E]/10 dark:bg-[#FFC81E]/30 text-[#FFC81E] dark:text-emerald-300",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
  sowing: {
    color: "#FEFDDF",
    headerBg: "bg-[#FEFDDF]/8 dark:bg-[#FEFDDF]/20",
    headerText: "text-[#FEFDDF] dark:text-purple-300",
    accentText: "text-[#FEFDDF] dark:text-purple-300",
    badge: "bg-[#FEFDDF]/10 dark:bg-[#FEFDDF]/30 text-[#FEFDDF] dark:text-purple-300",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
  want: {
    color: "#E87F24",
    headerBg: "bg-[#E87F24]/8 dark:bg-[#E87F24]/20",
    headerText: "text-[#E87F24] dark:text-orange-300",
    accentText: "text-[#E87F24] dark:text-orange-300",
    badge: "bg-[#E87F24]/10 dark:bg-[#E87F24]/30 text-[#E87F24] dark:text-orange-300",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
};
