...
const GROUP_STYLES: Record<string, GroupStyle> = {
  ...
  necessity: {
    color: "#FFC81E",
    headerBg: "bg-amber-50 dark:bg-[#FFC81E]/20",
    headerText: "text-amber-800 dark:text-amber-200",
    accentText: "text-amber-800 dark:text-amber-200",
    badge: "bg-amber-50 dark:bg-[#FFC81E]/30 text-amber-800 dark:text-amber-200",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
  sowing: {
    color: "#B89B4A",
    headerBg: "bg-amber-50 dark:bg-[#B89B4A]/20",
    headerText: "text-amber-900 dark:text-[#D4C675]",
    accentText: "text-amber-900 dark:text-[#D4C675]",
    badge: "bg-amber-50 dark:bg-[#B89B4A]/20 text-amber-900 dark:text-[#D4C675]",
    border: "border-gray-100 dark:border-[#2d3748]",
    warningBorder: "border-orange-300 dark:border-orange-600",
  },
  want: {
